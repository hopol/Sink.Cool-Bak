#!/usr/bin/env bash
# 手动镜像 miantiao-me/sink 的 master 分支。
set -euo pipefail

UPSTREAM_URL="https://github.com/miantiao-me/sink.git"
UPSTREAM_WEB_URL="https://github.com/miantiao-me/sink"
UPSTREAM_BRANCH="master"
MIRROR_REPO="https://github.com/hopol/Sink.Cool-Bak"
...
git add upstream
git commit -m "chore: mirror Sink.Cool-Bak source $SOURCE_VALUE ($SHORT_COMMIT)"
git tag -a "mirror-source-v$SOURCE_VALUE-$SHORT_COMMIT" -m "Mirror Sink.Cool-Bak source $SOURCE_VALUE ($SHORT_COMMIT)"
git push origin HEAD
git push origin "mirror-source-v$SOURCE_VALUE-$SHORT_COMMIT"
echo "已同步 Sink.Cool-Bak $UPSTREAM_BRANCH：$UPSTREAM_COMMIT"
